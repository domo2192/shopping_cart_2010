...
class MarketTest < Minitest::Test
  ...
  def test_we_can_return_just_names_of_vendors
    @market.add_vendor(@vendor1)
    @market.add_vendor(@vendor2)
    @market.add_vendor(@vendor3)
  ...
  def test_we_can_find_vendors_that_sell_specific_items
    @market.add_vendor(@vendor1)
    @market.add_vendor(@vendor2)
    @market.add_vendor(@vendor3)
    @vendor1.stock(@item1, 35)
  ...
  def test_we_can_find_potential_revenue
      @market.add_vendor(@vendor1)
      @market.add_vendor(@vendor2)
      @market.add_vendor(@vendor3)
      @vendor1.stock(@item1, 35)
  ...
  def test_over_stocked_items
    ...
    @vendor3.stock(@item1, 65)
    @vendor3.stock(@item3, 10)
    assert_equal [@item1], @market.over_stocked_items
  end
